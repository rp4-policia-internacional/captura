...
let CreateCapturaRepository = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  return (0, _tsyringe.inject)('CapturaRepository')(target, undefined, 0);
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _ICapturaRepository.default === "undefined" ? Object : _ICapturaRepository.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = class CreateCapturaRepository {
...
var _default = CreateCapturaRepository;
